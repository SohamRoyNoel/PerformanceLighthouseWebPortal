...
<head>
	...
	<!-- Fusion -->
	<script type="text/javascript" src="public/vendor/FusionCharts/js/fusioncharts.js"></script>
...
function pageRedirect() {
	    window.location.replace("https://performancehouse.azurewebsites.net/public/login.jsp");
         ...
         $('#rngpicker').click(function(event) {	
        	 ...
        	 // get page name
         $('#applicationName').click(function(event) {	
                 var applicationname = $("select#applicationName").val();
...
<body>
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="public/images/thumbnail.png" style="height: 45px; width: 350px;" alt="Cool Admin" />
                </a>
            </div>
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="public/images/avt.jpg" alt="JHancock" />
                                        </div>
                                        <div class="content">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                <div class="image">
                                                    <a href="#">
                                                        <img src="public/images/avt.jpg" alt="John Hancock" />
                                                    </a>
                                                </div>
                                                <div class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                <div class="au-card-title" style="background-image:url('images/bg-title-02.jpg');">
                                    <div class="bg-overlay bg-overlay--blue"></div>
                                    <h3>
                                        <i class="zmdi zmdi-comment-text"></i>Max, Mean, Min Loading Times (Seconds)
                                    </h3>
                                </div>
                                <div class="au-card chart-percent-card" style="height: 500px;">
                                    <div class="au-card-inner">                                        
