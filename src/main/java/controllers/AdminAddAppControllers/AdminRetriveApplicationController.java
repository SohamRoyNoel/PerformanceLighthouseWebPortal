...
public class AdminRetriveApplicationController extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public AdminRetriveApplicationController() {
        super();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ResultSet rs = null;
        String stss = "User";
        String askapplication = Queries.retriveApplicationForAdmin(intAppID);
